        ...
        return this.each(function () {
            ...
            function g(t) {
                switch (M.forcestepdivisibility) {
                    case "round":
                        return (Math.round(t / M.step) * M.step).toFixed(
                            M.decimals
                        );
                    case "floor":
                        return (Math.floor(t / M.step) * M.step).toFixed(
                            M.decimals
                        );
                    case "ceil":
                        return (Math.ceil(t / M.step) * M.step).toFixed(
                            M.decimals
                        );
                    default:
                        return t;
            ...
            function _() {
                ...
                (S += o),
                    S > M.max &&
                        ((S = M.max), E.trigger("touchspin.on.max"), F()),
            ...
            function C() {
                ...
                (S -= o),
                    S < M.min &&
                        ((S = M.min), E.trigger("touchspin.on.min"), F()),
